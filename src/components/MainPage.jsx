const MainPage = () => {
  ...
  return (
    <div id="home" className="grid grid-cols-2 lg:grid-cols-3 h-[650px] bg-black px-[5%] sm:px-[8%] pb-[3%] sm:py-[3%]">
      <div className="col-span-2 grid place-items-center bg-black text-white mx-auto">
        <div className="">
          ...
          <h1 className="text-xl">
            ...
            <span className="text-[30px] sm:text-7xl font-bold italic nameContainer">
                <span>A</span>
                <span>d</span>
                <span>i</span>
                <span>t</span>

  ...
  return (
    <div id="project" className="px-[8%] py-[5%] bg-black text-orange-300">
      ...
      <div className="grid grid-cols-2 bg-black text-white">
        <div className="h-[450px] w-[400px] bg-slate-200 m-auto relative">
          <img
        ...
        <div className="flex justify-center flex-col pr-20">
          ...
          <ul>
            <li className="mb-1 font-medium text-pretty text-md hover:text-orange-300 cursor-zoom-in">
          ...
          <a href="https://lively-mooncake-88c2cf.netlify.app">
            ...
            <button className="px-4 py-2 border border-orange-500 rounded-md text-black bg-orange-500 hover:bg-black transition duration-500 font-semibold hover:text-orange-400">
              <a href="https://github.com/Aditya0933/NetflixGPT3.0">View Code</a>
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="h-[450px] w-[400px] bg-slate-200 m-auto relative">
        ...
        <div className="flex justify-center flex-col pr-20">
          ...
          <div className="mt-6">
            ...
            <button className="px-4 py-2 border border-orange-500 rounded-md text-black bg-orange-500 hover:bg-black transition duration-500 font-semibold hover:text-orange-400">
              <a href="https://github.com/Aditya0933/StarytoStayProjectUpdated">View Code</a>
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="h-[450px] w-[400px] bg-slate-200 m-auto relative">
        ...
        <div className="flex justify-center flex-col pr-20">
          ...
          <a href="https://aditya0933.github.io/MemoryGameUpdated/">
            ...
            <button className="px-4 py-2 border border-orange-500 rounded-md text-black bg-orange-500 hover:bg-black transition duration-500 font-semibold hover:text-orange-400">
              <a href="https://github.com/Aditya0933/MemoryGameUpdated">View Code</a>
            </button>
          </div>
        </div>
      </div>
